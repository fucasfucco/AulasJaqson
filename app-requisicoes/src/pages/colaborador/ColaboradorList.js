...
const ColaboradorList = (props) => {
  ...
  return (
    <div className="App">
      ...
      <DataTable value={props.colaboradores} paginator responsiveLayout="scroll" rows={5}
        paginatorTemplate="CurrentPageReport FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink RowsPerPageDropdown"
        currentPageReportTemplate="Mostrando {last} colaboradores de {totalRecords}" rowsPerPageOptions={[10, 20, 50]}
        selectionMode="single" selection={props.colaborador} onSelectionChange={e => props.setColaborador(e.value)} dataKey="_id" emptyMessage="Nenhum colaborador encontrado">
